...
export const NPC_DEFINITIONS: NPCDefinition[] = [
  ...
  },
  {
    ...
    personality: 'Заходит почти каждый день — обычно с внучкой Настей, шесть лет, чёлка до глаз. Помнит, как тут раньше были «Хлеб» и «Овощи». Эмоциональный барометр района.',
