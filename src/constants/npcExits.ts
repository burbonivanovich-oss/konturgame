...
function achievedClosure(
  ...
  switch (goal.id) {
    case 'mother_surgery':
      return {
        title: 'Мама — в палате',
        text: 'Подписали с клиникой. Анестезия три часа, операция четыре, потом тишина. Сидите в коридоре, держите её сумочку. Когда она открывает глаза — спрашивает «ну как там у тебя в магазине». Не «спасибо». «Как у тебя». Это и есть ответ.',
      }
    case 'dimka_cosign':
      return {
        title: 'Димка — свободен',
        text: 'Закрыли кредит, подписали в банке снятие поручительства. Звоните Димке: «Слушай, я тут рефинансировался. Тебя освободили — приходи в понедельник, подпишешь». Долгая пауза. «Старик. Я думал, ты не справишься. Прости, что думал». Это вам он простил, не себе.',
      }
    case 'grandma_flat':
      return {
        title: 'Бабушкина квартира — ваша',
        text: 'Подписи у нотариуса. Ключи — те самые, с латунным брелком. Зашли в квартиру, поставили сумку у двери. На кухне — её клеёнка, которую дядя не выкинул. Сели на её стул. Ничего не сказали. И никому не позвонили.',
      }
  }
}
...
function missedClosure(
  ...
  switch (goal.id) {
    case 'mother_surgery':
      return {
        title: 'Мама — в районной',
        text: 'Перевели в государственную, палата на восемь. Хирург сказал «сделаем что сможем». Вы привезли бельё, тапочки, банку морса. Мама улыбается: «Не переживай, у тебя бизнес — главное чтоб у тебя получилось». Она впервые за жизнь сказала так — и это страшнее любых анализов.',
      }
    case 'dimka_cosign':
      return {
        title: 'Списания пошли',
        text: 'Банк прислал Димке требование. Он перезвонил вам — голос ровный, слишком ровный. «Слушай, я не могу сейчас разговаривать». Это «сейчас» длится уже три недели. Жена его перестала здороваться. Вы делаете вид, что не заметили.',
      }
    case 'grandma_flat':
      return {
        title: 'Чужая лампа в её окне',
        text: 'Дядя продал. Прошли мимо дома вечером — в её окне горит чужая лампа, видны новые шторы. Хорошие люди, наверное. Постояли минуту. Никому не сказали, что приходили. Это и было важнее всего: что приходили.',
      }
  }
}
