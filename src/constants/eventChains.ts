...
export const CHAIN_EVENTS: EventTemplate[] = [
  ...
  // Trigger: week 3–5. Михаил просит предоплату — у него семейные проблемы.
  {
    ...
    description: 'Михаил Власов, ваш поставщик, пришёл лично. Выглядит уставшим. Поставил на прилавок пакетик с карамельками — привычка, он всегда приносит какое-то угощение. "Слушайте, у меня ситуация... жена в больнице, операция срочная. Мне нужна предоплата за следующую партию — прямо сейчас, 30 000 ₽. Я вам всё отдам через три недели, вы же меня знаете."',
...

  {
    ...
    description: 'Михаил появился ровно через три недели. Положил на стол 30 000 ₽, конверт и коробку зефира — «от жены, она сказала обязательно». "Спасибо. Жена уже дома. Я вам должен — вот скидка 12% на следующие два месяца и кое-что важное: ваш конкурент Анна переманивает моего коллегу-поставщика. Будьте осторожны с поставками в ноябре."',
  ...
  // Week 10: Анна предлагает «договориться». Week 18+: итоги.
  {
    ...
    description: 'Анна Козлова, ваш конкурент, зашла лично. Без предупреждения. Стула не взяла — стоит у прилавка, постукивает ноготком по столешнице, явно между делом. "Мы оба теряем деньги на этой войне. Предлагаю: я не демпингую, вы не переманиваете моих людей. Взаимный нейтралитет." Смотрит прямо. Непонятно — честно или нет. Через минуту она уже у двери.',
...

  {
    ...
    description: 'Анна запустила скидку 40% на весь ассортимент и развесила объявления прямо у вашей двери. Ваши постоянные клиенты уходят к ней. Потом узнаёте: она сделала то же самое с другими партнёрами — всегда нарушает договорённости, когда это выгодно. Соседка говорит, что видела её утром: пришла, расклеила сама, ушла за пять минут.',
  ...
  // Тамара заходит с внучкой Настей (шесть лет, чёлка до глаз) — пара,
  // без которой район не район. Тамара помнит, как тут раньше были
  // «Хлеб» и «Овощи», лет десять назад. Настя любит печенье «сердечки»
  // — у неё своё имя для печенья «с пуговками».
  {
    id: 'tamara_arc_1',
    title: 'Бабушка Тамара зашла с внучкой',
    description: 'Невысокая женщина в платке, лет за семьдесят, придерживает за руку девочку лет шести с чёлкой до глаз. «Это Настя. Мы тут к вам уже месяц — она печенье любит, „сердечки“, у вас всегда свежее». Считает сдачу — копейка к копейке. Тихо: «Я ведь помню, как тут раньше „Хлеб“ был, потом „Овощи“. Хорошо, что сейчас вы. Люди заходят». Настя машет рукой и тянет бабушку к выходу.',
    trigger: {
      dayMin: 56, // ~week 8
      dayMax: 84, // ~week 12
      randomChance: 1.0,
    ...
    options: [
      {
        id: 'thank_warm',
        text: 'Поблагодарить и сказать, чтоб заходили почаще',
        consequences: {},
        npcRelationshipDelta: 4,
        chainFollowUpId: 'tamara_arc_2',
      },
      {
        id: 'gift_extra_cookies',
        text: 'Положить Насте лишнее «сердечко» — «бабушке передай»',
        consequences: { balanceDelta: -100, reputationDelta: 1 },
  ...
  {
    id: 'tamara_arc_2',
    title: 'Настя пришла одна',
    description: 'Утром в магазин зашла Настя — без бабушки. Вытащила мелочь из кулака, три монеты по десять. «Бабушка приболела. Она просила хлеб и — ну, который с пуговками. Я сама. Я уже умею». Стоит у прилавка серьёзная, как взрослая. Соседка позже пояснила: воспаление лёгких, тяжело. Дочка из Твери приехала, ходит за обеими. «Тамара вас вспоминала. Говорила — там хорошие люди».',
    trigger: {
      dayMin: 0,
      dayMax: 9999,
      randomChance: 1.0,
    ...
    options: [
      {
        id: 'serve_nastya_seriously',
        text: 'Обслужить Настю как взрослую, передать «сердечек» бабушке в подарок',
        consequences: { balanceDelta: -200, energyDelta: -3 },
        npcRelationshipDelta: 8,
        chainFollowUpId: 'tamara_arc_3a',
      },
      {
        id: 'visit',
        text: 'Закрыть пораньше, заехать к Тамаре с пакетом мандаринов',
        consequences: { energyDelta: -5 },
        npcRelationshipDelta: 8,
        chainFollowUpId: 'tamara_arc_3a',
      },
      {
        id: 'pass',
        text: 'Отсчитать ровно по чеку — Настя справится сама',
        consequences: {},
        npcRelationshipDelta: -6,
  ...
  {
    id: 'tamara_arc_3a',
    title: 'Прощание с календарём',
    description: 'Тамара пришла с Настей, с пакетом — последний раз. «Дочка забирает к себе насовсем. Настю тоже — там школа хорошая. Я сюда — попрощаться». Долго смотрит в зал. «Знаешь, я тут полжизни прожила. Ваше место — последнее, к которому я привыкла. Не закрывайте, ладно?» Настя достаёт из пакета старый деревянный календарь, тычет пальчиком: «Я нарисовала ёлку. Это вам. Чтобы помнили нас».',
    trigger: {
      dayMin: 0,
      dayMax: 9999,
      randomChance: 1.0,
    ...
    options: [
      {
        id: 'see_her_out',
        text: 'Проводить до выхода, поставить календарь у кассы',
        consequences: { reputationDelta: 2 },
        npcRelationshipDelta: 6,
      },
      {
        id: 'farewell_gift',
        text: 'Собрать Насте «сердечек» в дорогу (−200 ₽)',
        consequences: { balanceDelta: -200, reputationDelta: 3, loyaltyDelta: 2 },
        npcRelationshipDelta: 10,
      },
    ],
  },

  {
    ...
    description: 'На прилавке — сложенный вчетверо листок. Соседка занесла утром, не дождалась. «Тамара Ивановна слегла окончательно. Дочка перевозит её и Настю к себе в Тверь, лечиться. Просили передать спасибо всем, кто её знал — вы у неё в записях были. Настя плакала, говорила, что обещала какую-то ёлку нарисовать». Внизу — телефон. Печенья «сердечками» сегодня к чаю не будет.',
    trigger: {
      dayMin: 0,
      dayMax: 9999,
      randomChance: 1.0,
    ...
    options: [
      ...
      {
        id: 'call_back',
        text: 'Позвонить вечером — узнать как доехали',
        consequences: { energyDelta: -2, reputationDelta: 1 },
        npcRelationshipDelta: 4,
      },
    ],
  },
...
export const CHAIN_FOLLOWUP_DELAY: Record<string, number> = {
  ...
  // пройти ~неделю (объявления, собеседования). Спринт 6: 2→1 неделя
  // после Game Designer аудита M1 — cafe-solo-aggressive выгорает к W5,
  // а SOLO_OVERLOAD fires W5-6, кандидат был на W7-8 (после выгорания).
  // С 1-нед задержкой кандидат прилетает на W6-7, до burnout-warning.
  first_hire_options: 1,
