...
export const WEEKLY_TACTICS: WeeklyTacticDef[] = [
  ...
  },
  {
    ...
    blurb: '−2% выручки, +0.3 энергии, +0.8 репутации и +0.5 лояльности в день',
    // Спринт 5c: добавлен +0.3 энергии/день — концентрация на качестве
    // изматывает меньше, чем гонка за выручкой. Реп/лояльность остались
    // прежними: 4 недели service = +22.4 реп, +14 лояльности — главный
    // канал восстановления после агрессивной фазы.
