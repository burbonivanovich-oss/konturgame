...
// SALARY_NOTE_SUFFIX был перемещён в description event'а — на мобильных
// длинные опции с повторяющимся суффиксом ломали layout.
...
export const FIRST_HIRE_OPTIONS: EventTemplate = {
  ...
  options: [
    ...
    {
      id: 'hire_relative',
      text: '👨 Дальний родственник: 25 000 ₽/мес — без опыта, придётся всё перепроверять',
      consequences: {
        balanceDelta: -3000,
        loyaltyDelta: -3,
        hireEmployee: {
    ...
    {
      id: 'hire_student',
      text: '👨‍🎓 Студент Никита, 3-й курс: 35 000 ₽/мес — будет учиться по ходу, но схватывает быстро',
      consequences: {
        balanceDelta: -4000,
        loyaltyDelta: 0,
        hireEmployee: {
    ...
    {
      id: 'hire_friend',
      text: '👨 Олег, 39: 38 000 ₽/мес — работает нормально, но без огонька',
      consequences: {
        balanceDelta: -4500,
        loyaltyDelta: 0,
        hireEmployee: {
    ...
    {
      id: 'hire_pro_cafe',
      text: '🍳 Сергей, повар из закрывшегося ресторана: 55 000 ₽/мес — 12 лет в общепите, класс виден сразу',
    ...
    {
      id: 'hire_pro_shop',
      text: '🏪 Алла, продавец из обанкротившегося «Магнита»: 55 000 ₽/мес — 10 лет на кассе, класс виден сразу',
    ...
    {
      id: 'hire_pro_salon',
      text: '💇 Лариса, парикмахер из закрытого салона: 55 000 ₽/мес — со своей клиентурой, готова к работе',
...
/**
 * Михаил между делом упоминает племянницу (Спринт 5e).
 *
 * Срабатывает на W19 (за неделю до svetlana_intro), даёт нарративный мост
 * между дневниковой ремаркой игрока (W15) и приходом Светланы (W20).
 * Без выбора — однострочная реплика на выходе из обычной закупки.
 *
 * Гейтится по revealed-статусу Михаила (был в mikhail_crisis на W3-5).
 */
export const MIKHAIL_RECOMMENDS_SVETLANA: EventTemplate = {
...
export const SVETLANA_INTRO: EventTemplate = {
  ...
  description:
    'Пятница, восемь вечера, дверь должна быть закрыта. Стук. На пороге девушка, 22 года, кроссовки, рюкзак. «Здравствуйте. Я Светлана, мне дядя Миша сказал, что вам, возможно, нужен ещё человек. Я понимаю, что не самое удачное время вечером в пятницу, но я подумала — лучше так, чем неделю переписки».\n\nТолько защитила диплом политеха. Во время учёбы три года подрабатывала у тёти в районном магазинчике — закупки, остатки, иногда касса; плюс организовывала их сезонные акции. Серьёзного резюме нет.\n\nИз папки достаёт лист — план на первый месяц у вас, по неделям. Внутри плана три идеи, до которых вы сами не додумались. На вопрос «сколько просите» — 60 тысяч. «Я знаю, что для выпускницы это много, но я претендую на управление, не просто помогать на смене». Не торгуется.',
  trigger: {
    dayMin: 0, dayMax: 9999, randomChance: 1.0, oneTime: true,
  ...
  options: [
    {
      id: 'hire',
      text: '⭐ Принять — талант не часто стучится. 60 000 ₽/мес — управленец, разгрузит вас и подтянет команду',
      consequences: {
        balanceDelta: -8000,
        loyaltyDelta: 6,
        reputationDelta: 2,
  ...
  options: [
    {
      ...
      text: '👨‍🎓 Никита, 3-й курс политеха: 35 000 ₽/мес — учится по ходу, но схватывает быстро',
      consequences: {
        balanceDelta: -4000,
        loyaltyDelta: 0,
        hireEmployee: {
    ...
    },
    {
      ...
      text: '🍳 Сергей, повар: 55 000 ₽/мес — 12 лет в общепите, класс виден сразу',
      requiredBusinessTypes: ['cafe'],
      consequences: {
        balanceDelta: -7000,
        loyaltyDelta: 5,
    ...
    },
    {
      ...
      text: '🏪 Алла, продавец: 55 000 ₽/мес — 10 лет на кассе, класс виден сразу',
      requiredBusinessTypes: ['shop'],
      consequences: {
        balanceDelta: -7000,
        loyaltyDelta: 5,
    ...
    },
    {
      ...
      text: '💇 Лариса, парикмахер: 55 000 ₽/мес — со своей клиентурой',
      requiredBusinessTypes: ['beauty-salon'],
      consequences: {
        balanceDelta: -7000,
        loyaltyDelta: 5,
