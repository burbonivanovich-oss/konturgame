 ...
 *        • Соседка после декрета (50К, 1.2, 4) — взрослая ответственная
...
export const FIRST_HIRE_OPTIONS: EventTemplate = {
  ...
  options: [
    ...
    // ── Соседка после декрета: дороже, опытная ────────────────────────
    {
      id: 'hire_neighbor',
      text: '👩 Соседка после декрета: 50 000 ₽/мес, 8 лет в торговле' + SALARY_NOTE_SUFFIX,
      consequences: {
        balanceDelta: -6000,
        hireEmployee: {
          position: 'assistant',
          salary: 50000,
          efficiency: 1.2,
          energyCost: 4,  // взрослая, самостоятельная
          name: 'Марина',
        },
      },
    },
