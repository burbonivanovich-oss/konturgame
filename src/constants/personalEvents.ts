...
export const PERSONAL_BACKSTORY_EVENTS: EventTemplate[] = [
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    description:
      'Звонок с незнакомого номера. Голос узнаёшь сразу — Виктор Андреевич, твой шеф в той корпорации. «Слушай, у нас открылось руководящее место, под тебя. Зарплата плюс 30%, опцион. Подумай — у тебя там, я слышал, не сахар». Голос участливый. Это плохой знак.',
    trigger: {
      dayMin: 70,  // ~week 10
      dayMax: 140, // ~week 20
      randomChance: 0.8,
