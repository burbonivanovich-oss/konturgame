    ...
    steps: [
      {
        ...
        text: 'Отлично! Вы приняли первых клиентов. Теперь нужна касса — она определяет, сколько клиентов вы можете обслужить. Но касса без ОФД = штраф.',
      },
      {
        id: '1-1',
        title: 'Контур.ОФД обязателен',
        text: 'Каждый чек должен идти в налоговую. Без Контур.ОФД вы рискуете штрафами. Подключите его прямо сейчас — это обязательно.',
