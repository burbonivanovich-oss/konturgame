...
export const TUTORIAL_MOMENTS: TutorialMoment[] = [
  ...
  },
  {
    ...
    body: 'В разделе «Реклама» можно запускать кампании: промо, листовки, блогер.\n\nКаждая даёт +клиентов или +чек на 10-14 дней. Можно держать до 3 одновременно — но эффект уменьшается с каждой следующей. ROI отслеживается внизу того же экрана.',
    targetNav: 'marketing',
    ctaLabel: 'К рекламе',
    shouldShow: (s) =>
      (s.currentWeek ?? 1) >= 5 &&
