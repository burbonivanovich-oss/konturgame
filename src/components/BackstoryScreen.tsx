...
const PERSONAL_SITUATIONS: Array<{
...
}> = [
  {
    id: 'free',
    icon: '💳',
    title: 'На вас висят три долга',
    description: 'Кредитка 380 тысяч с процентами. Потребительский 350 — брал на запуск, думал закрою. Плюс 270 у мамы, она не напоминает. Хотите расквитаться со всем разом — миллион к концу года.',
  },
  {
    id: 'friend',
    icon: '🎓',
    title: 'Брат поступил на платное',
    description: 'Не дотянул три балла. Институт даёт −15% если оплатить три курса вперёд — 1.1 миллион вместо 1.3. Родители не вытянут. Первый этап — на вас, к началу учебного года.',
  },
  {
    id: 'hometown',
    icon: '🔑',
    title: 'Своя квартира',
    description: 'Тридцать лет, всё ещё у родителей. Подсмотрели студию в Кировском: первый взнос 1.2 миллиона, остальное — ипотека. К весне, пока продавец держит цену.',
  },
]
