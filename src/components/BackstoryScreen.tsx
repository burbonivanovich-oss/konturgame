...
const PERSONAL_SITUATIONS: Array<{
...
}> = [
  {
    id: 'free',
    icon: '💳',
    title: 'Висит кредитка',
    description: 'С 2022-го: лимит 350 тысяч, минимальный платёж — всё уходит в проценты. Хотите закрыть до Нового года и больше никогда не возвращаться к этой строчке в банковском приложении.',
  },
  {
    id: 'friend',
    icon: '🎓',
    title: 'Брат поступил на платное',
    description: 'Не дотянул три балла до бюджета. Родители не вытянут — мамина зарплата в школе и папина пенсия. Договорились: первый курс — за вами, дальше он сам. К сентябрю.',
  },
  {
    id: 'hometown',
    icon: '🔑',
    title: 'Хозяин хочет продавать',
    description: 'Арендодатель-пенсионер каждые полгода грозит поднять или продать. Через риелтора узнали — готов продать за 400 тысяч до зимы. Свой угол вместо вечной нервотрёпки.',
  },
]
