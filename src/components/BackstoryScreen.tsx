...
const PERSONAL_SITUATIONS: Array<{
...
}> = [
  {
    ...
    description: 'Ни жены, ни детей. Зато мама в районной поликлинике. Доктора уже что-то говорят, мама пока отмалчивается.',
  },
  {
    id: 'friend',
    icon: '🤝',
    title: 'Друг, который поручился',
    description: 'Когда вы открывались, Димка подписался поручителем по кредиту. Он не вспоминает. Вы — каждый день.',
  },
  {
    id: 'hometown',
    icon: '🏘️',
    title: 'Свой район, свои тени',
    description: 'Выросли здесь. Знаете половину жителей. Бабушку похоронили в позапрошлом, у неё осталась квартира.',
  },
]
