...
const PERSONAL_SITUATIONS: Array<{
...
}> = [
  {
    id: 'free',
    icon: '🚙',
    title: 'Семьи нет — только мама',
    description: 'Ни жены, ни детей. Маме в этом году 60. Всю жизнь на маршрутках — пора подарить ей хоть какую-нибудь свою.',
  },
  {
    id: 'friend',
    icon: '💍',
    title: 'Друг зовёт свидетелем',
    description: 'Димка наконец делает Ирке предложение. Свадьба осенью, он попросил быть свидетелем — и тихо рассказал, что бюджет не сходится.',
  },
  {
    id: 'hometown',
    icon: '⚽',
    title: 'Свой район, своя команда',
    description: 'Выросли здесь. Во дворе ваше детство гоняло мяч. Сейчас тренер у пацанов уволился — без него команда рассыплется.',
  },
]
