...
// Brand-color свечки каждого продукта Контура. Берутся с иконок продуктов
// из фирменного гайда (см. «Список иконок» в дизайн-системе SKB Kontur).
// Используется в ServicePanel/DesktopKontur, чтобы каждый сервис узнавался
// в эко-панели по цвету так же, как в реальном продуктовом UI.
export const PRODUCT_COLORS = {
  bank:   '#1FA1FF',  // Контур.Банк — светло-синий
  market: '#2C5FE6',  // Контур.Маркет — насыщенный синий
  ofd:    '#FF6B00',  // Контур.ОФД — фирменный оранжевый
  diadoc: '#1FA84E',  // Контур.Диадок — тёмно-зелёный
  fokus:  '#13B36E',  // Контур.Фокус — ярко-зелёный
  elba:   '#E94B71',  // Контур.Эльба — розово-коралловый
  extern: '#0FA98F',  // Контур.Экстерн — бирюзово-зелёный
} as const
