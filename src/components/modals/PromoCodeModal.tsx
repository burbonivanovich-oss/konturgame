...
export default function PromoCodeModal() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: K.white, borderRadius: 24, padding: 28,
        ...
        <div style={{ fontSize: 11, fontWeight: 700, color: K.violet, marginBottom: 6, textTransform: 'uppercase', letterSpacing: '0.08em' }}>
          🎉 Промокод получен!
        </div>
        ...
        <div style={{ fontSize: 13, color: K.muted, marginBottom: 20, lineHeight: 1.5 }}>
          {data.offerText}
        </div>

        {/* Promo code block */}
        <div style={{
          background: K.bone, borderRadius: 14, padding: 16, marginBottom: 20,
        }}>
          ...
          <div style={{
            ...
            letterSpacing: '0.12em', color: K.blue,
            marginBottom: 12,
          }}>
            {data.code}
          </div>
          <button
            ...
            style={{
              ...
              background: copied ? K.mint : K.blue,
              color: K.white, transition: 'background 0.2s', width: '100%',
            }}
          >
        ...
        <button
          ...
          style={{
            ...
            border: `1px solid ${K.line}`, cursor: 'pointer', width: '100%',
